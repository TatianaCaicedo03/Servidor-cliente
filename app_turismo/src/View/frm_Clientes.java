...
public class frm_Clientes extends JFrame {
	...
	public frm_Clientes() {
		...
		btnRegistrar.setIcon(new ImageIcon(
				"C:\\Users\\APRENDIZ\\Downloads\\2290866_documents_download_download files_file_files_icon.png"));
		...
		btnRegistrar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				cr.create(Integer.parseInt(txtid.getText()), Integer.parseInt(txttipodocumento.getText()),
		...
		btnRegistrar.setBounds(361, 167, 164, 45);
		...
		separator.setBounds(10, 223, 672, 14);
		contentPane.add(separator);

		JLabel lblNewLabel_2_1 = new JLabel("ID CLIENTE");
		lblNewLabel_2_1.setFont(new Font("Tahoma", Font.BOLD, 11));
		lblNewLabel_2_1.setBounds(179, 304, 92, 14);
		contentPane.add(lblNewLabel_2_1);

		txtID = new JTextField();
		txtID.setColumns(10);
		txtID.setBounds(268, 301, 83, 20);
		contentPane.add(txtID);
		...
		btnNewButton_1.setBounds(45, 350, 137, 54);
		contentPane.add(btnNewButton_1);

		JLabel lblNewLabel_1_3 = new JLabel("OPCIONES DE REGISTROS  EXISTENTES");
		lblNewLabel_1_3.setFont(new Font("Tahoma", Font.BOLD, 11));
		lblNewLabel_1_3.setBounds(179, 243, 243, 14);
		...
		btnNewButton_3.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				cr.Read(Integer.parseInt(txtID.getText()), txttipodocumento, txtdocumento, txtnombres, txtApellidos,
						txtEps, txtAlergias, txtFechaNacimiento, txtCorreo, txtEstadoCivil, txtTelefono);
			}
		});
		...
		btnNewButton_3.setBounds(208, 353, 153, 48);
		...
		btnUpdate.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				cr.Update(Integer.parseInt(txtid.getText()), Integer.parseInt(txttipodocumento.getText()),
						Integer.parseInt(txtdocumento.getText()), txtnombres.getText(), txtApellidos.getText(),
						txtEps.getText(), txtAlergias.getText(), txtFechaNacimiento.getText(), txtCorreo.getText(),
						txtEstadoCivil.getText(), txtTelefono.getText());
			}
		...
		btnUpdate.setBounds(385, 353, 172, 48);
