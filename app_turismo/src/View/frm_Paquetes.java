	...
	public frm_Paquetes() {
		...
		btnRegistrar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				cr.create(Integer.parseInt(txtIDDestino.getText()),Integer.parseInt(txtIDOrigen.getText()),txtFechaVenta.getText(),txtHoraVenta.getText(),txtHoraSalida.getText(),txtFechaEjec.getText(),txtObservacion.getText(),Integer.parseInt(txtIDPromotor.getText()),Integer.parseInt(txtIDCliente.getText()),Integer.parseInt(txtIdOperador.getText()),Integer.parseInt(txtMedio.getText()),txtPrecio.getText(),txtIDVehiculo.getText());
		...
		lblNewLabel_2.setBounds(430, 98, 119, 14);
		contentPane.add(lblNewLabel_2);
		
		txtCodigoVenta = new JTextField();
		txtCodigoVenta.setBounds(436, 114, 86, 20);
		contentPane.add(txtCodigoVenta);
		txtCodigoVenta.setColumns(10);
		
		JButton btnNewButton = new JButton("DELETE");
		btnNewButton.setFont(new Font("Tahoma", Font.BOLD, 11));
		btnNewButton.setIcon(new ImageIcon("C:\\Users\\APRENDIZ\\Downloads\\2290850_clean_delete_garbage_recycle bin_trash_icon.png"));
		...
		btnNewButton.setBounds(414, 179, 135, 50);
		contentPane.add(btnNewButton);
		
		JLabel lblNewLabel_1_2 = new JLabel("ELIMINAR REGISTRO EXISTENTE");
		lblNewLabel_1_2.setFont(new Font("Tahoma", Font.BOLD, 11));
		lblNewLabel_1_2.setBounds(393, 45, 186, 14);
